<template>
  ...
  export default {
    ...
    methods: {
      obtenerPalabras() {
        axios
          .get('https://edutlasdeveloper.pythonanywhere.com/api/showtable')
          .then((response) => {
      ...
      eliminarPalabra(id) {
        axios
          .delete(`https://edutlasdeveloper.pythonanywhere.com/api/palabras/${id}`)
          .then((response) => {
      ...
      openModal(id) {
        axios
          .get(`https://edutlasdeveloper.pythonanywhere.com/api/palabras/${id}/image`)
          .then((response) => {
